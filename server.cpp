...
// we try to see if the data in the incoming buffer is enough for one full msg
static bool try_one_request(Conn* conn) {
    ...
    // application logic rn just print the msg
    ...
    // empty parsed buffer
    buf_consume(conn->incoming, 4 + len); // not clearing bcz we might have some bytes of new msg
